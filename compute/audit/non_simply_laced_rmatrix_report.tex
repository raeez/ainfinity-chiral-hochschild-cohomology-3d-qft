...
The classical Yang--Baxter equation for $r_{12}(z) = k\,\Omega/z$
(trace convention; at $k=0$ the r-matrix vanishes and CYBE holds trivially,
AP126 satisfied) reduces to the level-independent infinitesimal braid relation:
\[
...
For affine Kac--Moody algebras the class-$L$ transfer is finite but not
Heisenberg-formal; these corrections enter through the Lie tree and the
KZ monodromy rather than through a Virasoro wheel tower.
