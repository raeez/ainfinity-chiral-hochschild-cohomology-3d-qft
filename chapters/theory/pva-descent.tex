...
\emph{homotopy chiral algebra} (HCA), and the PVA is the strict
shadow obtained by passing to cohomology.
...
\item $F_3$ is the Jacobiator homotopy: its vanishing on cohomology
  (Proposition~\textup{\ref{prop:m3_vanish}}) is the Jacobi identity
  for the PVA;
