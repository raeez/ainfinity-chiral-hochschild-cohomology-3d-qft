...
\begin{align}
\{\partial a_\lambda b\} &= -\lambda \{a_\lambda b\}, % label removed: eq:PVA1a\\
\{a_\lambda \partial b\} &= (\partial + \lambda) \{a_\lambda b\}. % label removed: eq:PVA1b
\end{align}

\textbf{(PVA2) Skew-symmetry}: For all $a, b \in V$,
\[
\{a_\lambda b\} = -\{b_{-\lambda - \partial} a\}, % label removed: eq:PVA2
\]
...
\begin{equation}
% label removed: eq:Jacobi_from_n3
