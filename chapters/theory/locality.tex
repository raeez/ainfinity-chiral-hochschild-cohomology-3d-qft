...
The open-sector factorization category~$\cC$ of a 3d HT theory on $\C \times \R$ is the primitive datum; the boundary algebra $A_b = \End_\cC(b)$ is its chart.  The two-coloured operad $\SCchtop$ governing the chart has chiral colour $\cP^{\mathrm{ch}}$ on $\FM_k(\C)$ (holomorphic collisions), topological colour $\Eone$ on $\Conf_k^{<}(\R)$ (ordered composition), and a Swiss-cheese coupling producing the $\Ainf$ chiral algebra structure.
