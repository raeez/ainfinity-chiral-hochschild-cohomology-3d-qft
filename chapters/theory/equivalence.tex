...
\noindent
\textbf{Reader's guide.}  This section is a signpost chapter that
summarises the equivalence between $W(\SCchtop)$-algebra structure
and the explicit $\Ainf$ chiral axioms.  The full proofs (the
operad-to-axioms direction
(Proposition~\ref{prop:operad-implies-axioms}) and the rectification
direction (Theorem~\ref{thm:rectification})) live in
Section~\ref{sec:axioms-Ainfty-chiral}; the present section records
the key ideas and cross-references without repeating the arguments.
