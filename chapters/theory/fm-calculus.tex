...
\]
and when $S$ is non-consecutive, the integrand has no net winding in the collision coordinate $\theta_S$ (the pole structure couples to the intermediate point $r$, which stays at finite distance). The angular integral therefore vanishes:
\[
