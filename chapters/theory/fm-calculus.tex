...
\textbf{Degree analysis}: The configuration space $\FM_3(\C)$ has real dimension $2(3-1) = 4$ after quotienting by translations, or equivalently real dimension $2(3) - 3 = 3$ after modding out by the full $\C \rtimes \R_{>0}$ action (translation $+$ scaling). The weight form $\omega_3$ is a top-degree form on this $3$-dimensional reduced space.
