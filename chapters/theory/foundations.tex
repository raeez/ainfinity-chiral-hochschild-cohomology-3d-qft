...
\phantomsection\label{ass:H1-H4}%
\phantomsection\label{rem:H1-H4-correspondence}%
...
\item \textbf{Theorem~B \textup{(}Koszul inversion\textup{)}.}
  ...
  non-formal case --- the groupoid carries genuine monodromy, and
