...
\item \textbf{Lines $=$ $\cC$ itself.}
  Line operators are objects of $\cC$.  Under open-colour Koszul
  duality (Theorem~\ref{thm:lines_as_modules}), $\cC$ is presented by
  modules over the open-colour Koszul dual of the boundary algebra
  $A_b$.
...
(ii) is Theorem~H of Volume~I: the polynomial
