...
operation spaces $\FM_k(\C) \times E_1(m)$.  Its algebras are the
...
a bordified curve.  The boundary
algebra $A_b = \RHom_{\cC(J)}(b,b)$ is a presentation of this
category, not its essence: different compact generators yield
...
different levels.  Neither is subordinate to the other; each is
essential.
...
% -------------------------------------------------------------------
\subsubsection{The line-operator category: MC couplings vs.\ Koszul
  modules}
