...
The bridge theorem (Theorem~\ref{thm:physics-bridge}) identifies the BV-BRST data of a 3d~HT theory on $\C_z \times \R_t$ with a logarithmic $\SCchtop$-algebra: the prefactorization algebra $U \mapsto \mathsf{Obs}(U)$ produces the open factorization category, and the quantum master equation $\hbar\Delta_{\mathrm{BV}} S_{\mathrm{eff}} + \tfrac{1}{2}\{S_{\mathrm{eff}}, S_{\mathrm{eff}}\}_{\mathrm{BV}} = 0$ becomes the open/closed MC equation.
