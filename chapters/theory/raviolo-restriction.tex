...
The \v{C}ech/Thom--Sullivan totalization of the raviolo factorization algebra (\S\ref{sec:raviolo}) computes derived global sections; the resulting coinvariant spaces are the conformal blocks.
