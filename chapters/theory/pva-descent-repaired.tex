...
The binary operation $m_2$ descends to a $(-1)$-shifted Poisson vertex algebra on $H^\bullet(\cA, Q)$: a commutative product and a skew-symmetric $\lambda$-bracket satisfying Jacobi and Leibniz.  Three points are essential.
...
The $(-1)$-shifted Poisson vertex algebra on $H^\bullet(\A,Q)$ is
\emph{related to} a $(-1)$-shifted symplectic structure in the sense of
Pantev--To\"en--Vaqui\'e--Vezzosi, but the passage involves two
non-trivial steps that should be made explicit.
