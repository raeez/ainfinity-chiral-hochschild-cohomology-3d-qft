...
associativity of Lagrangian convolution.  The complete
...
Curvature-braiding decoupling is perturbative exactness: the
Lagrangian self-intersection is clean, the genus tower acts by
scalars, and the $R$-matrix is determined once and for all at
genus~$0$.  Curvature-braiding entanglement is non-perturbative
structure: the Lagrangian self-intersection has excess, higher
...
is controlled by the Lagrangian intersection type---transverse
(simple poles, Koszul) versus excess (higher poles,
non-Koszul)---which is the geometric form of the
