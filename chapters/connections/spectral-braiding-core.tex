...
(ii)~$\Rightarrow$~(iii): Koszulness forces
$H^*(\bar{B}(\cA))$ to be concentrated in bar degree~$1$
(this is the defining property: the Koszul dual $\cA^!$
is the bar cohomology, and it sits in pure bar degree).
In particular $H^2(\bar{B}(\cA))$ lies entirely in bar
degree~$1$.
