...
\;\simeq\; \cA_{\cB}^!.
\]
The dual bulk shadow $\mathsf{Bulk}^{\vee}_{\cB} = \Omegach(\cA_{\cB}^!)$
is the cobar complex of this Koszul dual algebra, which recovers
$\cA_{\cB}$ by bar-cobar inversion (Theorem~B).
\end{enumerate}
\end{theorem}
