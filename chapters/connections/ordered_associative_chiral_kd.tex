...
The identity $d^2=0$ requires not the Arnold relation
(which involves \emph{unordered} triples) but the
\emph{ordered} analogue: the residue at $z_1=z_2=z_3$
along the ordered collision $z_1\to z_2\to z_3$ is
controlled by the associativity of the $E_1$-structure,
not by the Jacobi/Borcherds identity.
\end{definition}
