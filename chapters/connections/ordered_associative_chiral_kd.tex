...
\]
whose linear term is the genus anomaly, and whose arity-$2$
projection defines the formal ordered arity-$2$ shadow series
...
genus-refined arity-$2$ shadow package; interpreting it as a genuine
...
\item At arity~$2$: the ordered arity-$2$ collision residue
...
\item At genus~$1$: the coefficient $r_1(z)$ in the formal ordered
  arity-$2$ shadow series attached to the genus-$1$ sector of
  $\Theta^{E_1}_\cA$.
...
\begin{construction}[Modular ordered bar complex and formal ordered arity-$2$ shadow series;
\ClaimStatusProvedHere]
% label removed: constr:modular-ordered-bar
\index{bar complex!ordered!modular extension|textbf}
\index{arity-2 shadow!ordered genus refinement|textbf}
...
The \emph{formal ordered arity-$2$ shadow series} is the genus expansion
...
$r_g(z)$ ($g\ge 1$) the genus-$g$ arity-$2$ projection of
$\Theta_\cA^{E_1}$.

At genus~$1$, the coefficient $r_1(z)$ is the first higher-genus
ordered arity-$2$ correction.  On affine or free benchmark surfaces
