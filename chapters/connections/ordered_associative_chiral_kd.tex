...
bar complex
$\Barch_2^{\mathrm{ord}}=\bar\cA\otimes\bar\cA\otimes
C_\bullet(\mathrm{Conf}_2^{\mathrm{ord}})$
...
which holds because $d^2=0$ on $\Barch_2^{\mathrm{ord}}$.
...
\[
R(z)\colon
\Barch_2^{\mathrm{ord}}(a\otimes b;\,z_1,z_2)
\;\xrightarrow{\;\sim\;}
\Barch_2^{\mathrm{ord}}(b\otimes a;\,z_2,z_1).
\]
...
The operator $d^2$ on $\Barch_3^{\mathrm{ord}}$ composes
...
$\Barch_3^{\mathrm{ord}}$: the $R$-matrix intertwines the
