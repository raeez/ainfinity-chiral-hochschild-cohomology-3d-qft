...
The chain of functors from classical to modular data is:
\[
\text{PVA}
...
The bridge principle admits a transparent geometric mechanism via the
Steinberg correspondence, paralleling the Chriss--Ginzburg construction
of Hecke algebra representations from flag variety correspondences.
...
\begin{remark}
This is the chiral analog of how relations in the cohomology of flag
varieties give relations in the Hecke algebra via the Chriss--Ginzburg
convolution construction.
The Steinberg correspondence transmits geometric relations to algebraic
identities---one need not prove the algebraic identities directly.
The content of the tautological-to-holographic bridge
(Proposition~\ref{prop:tautological-holographic-bridge}) is precisely
that the Steinberg pullback--pushforward intertwines the tautological
ring with the operator algebra of the modular state space.
\end{remark}
