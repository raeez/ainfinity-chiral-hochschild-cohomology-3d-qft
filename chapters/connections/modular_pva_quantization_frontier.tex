...
physical-realisation inputs of
...
\ClaimStatusConjectured{} (conditional on the existence of the genus-$g$ Steinberg variety, Construction~\ref{con:genus-g-steinberg})]
...
(\S\ref*{sec:line_operators}, \S\ref*{sec:spectral_braiding}).
...
(due to Dimofte--Niu--Py~\cite{DNP2025}) has a direct consequence for the
...
$\Theta_{\cA}$ from the modular bar construction of Volume~I, this
separation is the genus filtration:
