...
\section{Instanton completion, screening, and the infrared frontier}
...
\begin{proposition}[Mass gap as spectral gap; \ClaimStatusConjectured]
\label{prop:mass-gap-spectral-gap}
...
The Hilbert-screening bridge datum is the map from the instanton-completed derived center
to the spectral gap criterion.
The visible-center collapse, the statement that only the scalar (trivial) component
of the derived center survives screening, is the algebraic incarnation of mass gap domination:
all non-trivial representations of the convolution algebra are gapped, and
the vacuum sector is separated from the first excited state by $m > 0$.
\end{remark}

\begin{remark}[Structural inevitability and the frontier]
\label{rem:steinberg-mass-gap-frontier}
This is deeply speculative but structurally inevitable from the Steinberg perspective:
the mass gap \emph{is} the spectral gap of the Steinberg correspondence.
