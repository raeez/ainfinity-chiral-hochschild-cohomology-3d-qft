...
\label{sec:thqg-gravitational-yangian}
...
(Theorem~\ref{thm:mc2-bar-intrinsic}), restricted to
...
\begin{equation}\label{eq:thqg-V-fm-stratum}
\sigma_T
\;\cong\;
...
\label{rem:thqg-V-collision-vs-arity}
...
\label{def:thqg-V-collision-filtration-grading}
\index{collision filtration!gravitational grading}
For a modular Koszul chiral algebra~$\cA$, define
\begin{equation}\label{eq:thqg-V-collision-filtration-grading}
F^d_{\mathrm{coll}}\,
...
\begin{equation}\label{eq:thqg-V-total-collision}
F^d_{\mathrm{coll}}\,
\mathfrak{g}^{g{=}0}_\cA
\;:=\;
\prod_{n \geq 2}
...
\label{lem:thqg-V-collision-lie-compatibility}
\index{collision filtration!Lie compatibility}
The collision filtration is a Lie filtration:
\begin{equation}\label{eq:thqg-V-lie-filtration}
\bigl[
...
\begin{equation}\label{eq:thqg-V-collision-ss}
E_1^{d,q}
\;=\;
H^{d+q}\!\bigl(
  \grcoll^d\,\mathfrak{g}^{g{=}0}_\cA,\;
...
\ClaimStatusProvedHere]
\label{prop:thqg-V-collapse-criterion}
...
(Corollary~\ref{cor:nms-betagamma-mu-vanishing}) kills $d_r$ for
...
\label{def:thqg-V-collision-differential}
\index{collision differential}
Define the \emph{collision differential} at depth~$d$ on the
$E_0$ page by
\begin{equation}\label{eq:thqg-V-collision-diff}
d_{\mathrm{coll}}^{(d)}
\;:=\;
\grcoll^d(D)\colon
\grcoll^d\,\mathfrak{g}^{g{=}0}_\cA
...
\ClaimStatusProvedHere]
\label{lem:thqg-V-collision-nilpotent}
...
\ClaimStatusProvedHere]
\label{prop:thqg-V-arnold-cohomology}
...
$1$-forms
\begin{equation}\label{eq:thqg-V-log-forms}
\eta_{ij}
\;=\;
d\log(z_i - z_j)
\;=\;
...
\begin{equation}\label{eq:thqg-V-arnold}
...
\begin{equation}\label{eq:thqg-V-arnold-algebra}
H^*(\Conf_n(\C);\,\C)
\;\cong\;
...
\label{rem:thqg-V-arnold-collision}
...
\ClaimStatusProvedHere]
\label{prop:thqg-V-poincare-collision}
...
\begin{equation}\label{eq:thqg-V-poincare}
P_n(t,q)
\;=\;
\sum_{d \geq 0} t^d\,
\dim H^*\!\bigl(
...
\label{subsec:thqg-V-binary-collision}
...
(Theorem~\ref{thm:mc2-bar-intrinsic}), restricted to the genus-zero
sector at arity $n = 2$ and to the codimension-$1$ stratum
$D_{12} = \{z_1 = z_2\}$, produces the collision residue
\begin{equation}\label{eq:thqg-V-binary-residue}
...
\ClaimStatusProvedHere]
\label{comp:thqg-V-heisenberg-r}
...
residue is
\begin{equation}\label{eq:thqg-V-heis-collision}
...
\begin{equation}\label{eq:thqg-V-heis-r}
r_{\mathcal{H}}(z)
\;=\;
\frac{1}{\kappa z}
\sum_{i=1}^N
...
\begin{equation}\label{eq:thqg-V-heis-ybe}
...
\begin{equation}\label{eq:thqg-V-affine-collision}
...
\begin{equation}\label{eq:thqg-V-sl2-r}
...
\]
the collision residue is
\begin{equation}\label{eq:thqg-V-vir-collision}
...
binary $r$-matrix is:
\begin{equation}\label{eq:thqg-V-vir-r}
\rgrav_{\mathrm{Vir}}(z)
\;=\;
\sum_{m,n \in \Z}
\frac{r_{mn}}{z}\,
...
\begin{equation}\label{eq:thqg-V-vir-r-coefficients}
r_{mn}
\;=\;
...
\ClaimStatusProvedHere]
\label{prop:thqg-V-gravitational-propagator}
...
\label{subsec:thqg-V-ternary-collision}
...
\label{lem:thqg-V-m04-structure}
...
D_s &\;:\; (z_1, z_2) \to z_{12},\;(z_3, z_4) \to z_{34}
  & \text{($s$-channel: $(12|34)$)},
  \label{eq:thqg-V-s-channel} \\
D_t &\;:\; (z_1, z_3) \to z_{13},\;(z_2, z_4) \to z_{24}
  & \text{($t$-channel: $(13|24)$)},
  \label{eq:thqg-V-t-channel} \\
D_u &\;:\; (z_1, z_4) \to z_{14},\;(z_2, z_3) \to z_{23}
  & \text{($u$-channel: $(14|23)$)}.
  \label{eq:thqg-V-u-channel}
\end{align}
...
\label{constr:thqg-V-mc-four-points}
...
\begin{equation}\label{eq:thqg-V-depth-1-mc}
...
\begin{equation}\label{eq:thqg-V-depth-2-mc}
\sum_{\text{channels}}
...
\ClaimStatusProvedHere]
\label{thm:thqg-V-cybe-from-arnold}
...
\begin{equation}\label{eq:thqg-V-cybe}
...
The MC equation
\begin{equation}\label{eq:thqg-V-mc-arity3}
D_\cA\Theta_{0,3}
\;+\;
...
\begin{equation}\label{eq:thqg-V-arnold-3pt}
\eta_{12} \wedge \eta_{23}
\;+\;
\eta_{23} \wedge \eta_{31}
\;+\;
...
\sum_{a,b} \bigl(\Omega_{31}^{ab}\,\Omega_{12}^{cd}
  ...
  \frac{1}{z_{31}\,z_{12}}
\;=\; 0.
\label{eq:thqg-V-arnold-tensored}
\end{align}
...
\label{rem:thqg-V-cybe-gravitational}
...
\begin{equation}\label{eq:thqg-V-ibr}
...
\begin{equation}\label{eq:thqg-V-ainfty-ybe}
\sum_{k=0}^{d}
...
\begin{equation}\label{eq:thqg-V-n-point-ybe}
...
\label{subsec:thqg-V-modular-yangian}
...
\ClaimStatusProvedHere]
\label{def:thqg-V-modular-yangian}
...
dg Lie algebra
\begin{equation}\label{eq:thqg-V-modular-yangian}
\Ymod_\cA
\;:=\;
\varprojlim_N\;
...
\end{equation}
where
\begin{equation}\label{eq:thqg-V-convolution}
\mathcal{L}_\cA^{\mathrm{mod}}
\;:=\;
\prod_{2g-2+n > 0}
\Hom\!\bigl(
...
\begin{equation}\label{eq:thqg-V-genus-zero-truncation}
\Ydg_\cA
\;=\;
\Ymod_\cA\big|_{g=0}
\;=\;
...
Definition~\textup{\ref{def:modular-yangian-pro}}]
\label{rem:thqg-V-yangian-comparison}
Definition~\ref{def:thqg-V-modular-yangian} is a restatement
of Definition~\ref{def:modular-yangian-pro} in the gravitational
...
\ClaimStatusProvedHere]
\label{thm:thqg-V-pro-mc-element}
...
\begin{equation}\label{eq:thqg-V-pro-mc}
...
\begin{equation}\label{eq:thqg-V-stable-graph-ybe}
...
\ClaimStatusProvedHere]
\label{cor:thqg-V-genus-one-correction}
...
$\delta H^{(1)}_\cA$:
\begin{equation}\label{eq:thqg-V-genus-one-r}
r_{\cA,1}(z)
\;=\;
...
\label{def:thqg-V-stable-graph-ybe}
...
\begin{equation}\label{eq:thqg-V-sgybe-expanded}
...
\begin{equation}\label{eq:thqg-V-qybe}
...
\label{rem:thqg-V-sgybe-scattering}
...
\ClaimStatusProvedHere]
\label{prop:thqg-V-pro-mc-convergence}
...
\ClaimStatusProvedHere]
\label{prop:thqg-V-rtt-from-sgybe}
...
\begin{equation}\label{eq:thqg-V-rtt}
...
\label{subsec:thqg-V-virasoro-yangian}
...
\begin{equation}\label{eq:thqg-V-vir-r-explicit}
\rgrav_{\mathrm{Vir}}(z)
\;=\;
\sum_{m \geq 0}
\frac{1}{z^{m+1}}\,
...
\label{eq:thqg-V-vir-omega0} \\
\Omega_1
&\;=\;
\sum_{n \in \Z}
n\,L_{-n} \otimes L_n,
\label{eq:thqg-V-vir-omega1} \\
\Omega_m
&\;=\;
\sum_{n \in \Z}
\binom{n+m-1}{m}\,L_{-n-m} \otimes L_n
\qquad (m \geq 0).
\label{eq:thqg-V-vir-omegam}
\end{align}
...
\begin{equation}\label{eq:thqg-V-vir-partial-fraction}
...
\ClaimStatusProvedHere]
\label{comp:thqg-V-three-graviton}
...
\begin{equation}\label{eq:thqg-V-three-graviton}
...
\begin{equation}\label{eq:thqg-V-three-graviton-amplitude}
...
\ClaimStatusProvedHere]
\label{comp:thqg-V-quartic-graviton}
...
any channel:
\begin{equation}\label{eq:thqg-V-quartic-contact}
...
\label{def:thqg-V-gravitational-hw}
...
\ClaimStatusProvedHere]
\label{prop:thqg-V-verma-gravitational}
...
representation:
\begin{equation}\label{eq:thqg-V-verma-evaluation}
...
\label{rem:thqg-V-gravitational-rep-category}
...
\label{subsec:thqg-V-line-operators-mc3}
...
\label{def:thqg-V-line-operator-category}
...
\begin{equation}\label{eq:thqg-V-line-category}
\cC_\cA
\;:=\;
\cA^!\text{-}\mathsf{mod}
\;=\;
...
\begin{equation}\label{eq:thqg-V-meromorphic-tensor}
...
\begin{equation}\label{eq:thqg-V-braiding}
\beta_{M,N}(z)\colon
M \otimes^{\mathrm{mer}}_z N
\;\xrightarrow{\;\sim\;}
...
\label{rem:thqg-V-meromorphic-braiding}
...
\bigr\rangle.
\end{equation}
This is the line-operator manifestation of the MC3 type-A resolution
\textup{(}Theorem~\textup{\ref{thm:mc3-type-a-resolution})}:
\begin{enumerate}[label=\textup{(\roman*)}]
...
\begin{equation}\label{eq:thqg-V-dk5}
...
\begin{remark}[MC3 for arbitrary type: the remaining frontier]
\label{rem:thqg-V-mc3-arbitrary-type}
\index{MC3!arbitrary type frontier}
For arbitrary simple $\fg$, the MC3 thick generation theorem remains
conjectural (Conjecture~\ref{conj:mc3-arbitrary-type}).  The
obstruction is the Hern\'andez--Jimbo prefundamental Clebsch--Gordan
closure for non-type-A Dynkin types: the character-level generation
(Step~2 above) requires a CG decomposition of the tensor product
$V_n \otimes L^-$ that is not yet available for all simple Lie
algebras.

In the gravitational Yangian context, this means: the line-operator
category for the gravitational theory associated to
$\widehat{\fg}_k$ is compactly generated in type~A, but the
generation in other types depends on the prefundamental CG input.
The gravitational $r$-matrix $\rgrav(z)$ exists for all simple
types (Theorem~\ref{thm:thqg-V-collision-twisting}); the gap is
in the categorical structure of its module category.
\end{remark}

\begin{construction}[MC3 difficulty gradient]
\label{constr:vol2-mc3-gradient}
MC3 is proved for type $A_n$
(Theorem~\ref{thm:mc3-type-a-resolution}).  For other types, the
status is as follows.
\begin{enumerate}[leftmargin=2.4em]
\item \textbf{$K_0$-level:} The character-level prefundamental
Clebsch--Gordan closure
(Proposition~\ref{prop:prefundamental-clebsch-gordan}) is proved
for all simple~$\fg$.
\item \textbf{Categorical lift:} The upgrade from $K_0$-identities
to module decompositions in $\cO^{\mathrm{sh}}$ is open for all
non-type-A types.  For $B_n$, a folding strategy is proposed
(Proposition~\ref{prop:mc3-type-b-folding},
\ClaimStatusConjectured) but the categorical lift of the folding
functor to shifted category~$\cO$ is unverified.  For $C_n$,
Langlands duality reduces to $B_n$.
\item \textbf{Difficulty gradient for remaining types:}
$D_n$/$E_6$ (grade~$B$, expected from simply-laced structure),
$E_7$ (grade~$C^+$), $G_2$ (grade~$C^-$, rank~$2$ amenable to
direct computation), $F_4$/$E_8$ (grade~$D$, zero minuscule
representations, may require Coulomb branch methods).
\end{enumerate}
\end{construction}

\begin{conjecture}[MC3 for type $B_2$: the smallest non-type-A test case]%
\label{conj:mc3-type-B2}
...
\begin{equation}\label{eq:mc3-B2-cg}
...
If this holds, then by the rank-independent arguments of
...
\smallskip\noindent
\textbf{What is known.}  Type $B_2$ has two fundamental weights
$\omega_1$ \textup{(}vector\textup{)} and $\omega_2$
\textup{(}spinor\textup{)}.  At the $K_0$-level,
the CG closure is proved
\textup{(}Proposition~\textup{\ref{prop:prefundamental-clebsch-gordan})}.
The categorical statement requires checking that the $K_0$-identity
lifts to an exact sequence of $Y(\mathfrak{so}_5)$-modules: the
extension classes must vanish in the shifted category.

\smallskip\noindent
\textbf{What would follow.}  MC3 for $B_2$ implies MC3 for $C_2$
\textup{(}by Langlands duality\textup{)}.  Since $B_2 = C_2$, this
gives a self-consistency check.  It would also be the first
non-type-A instance and a proof of concept for the folding strategy.
\end{conjecture}
...
\label{princ:thqg-V-yangian-shadow}
...
\begin{equation}\label{eq:thqg-V-ordered-face}
\Ydg_\cA
\;=\;
...
\ClaimStatusProvedHere]
\label{comp:thqg-V-heis-yangian}
...
\ClaimStatusProvedHere]
\label{comp:thqg-V-vir-yangian-summary}
...
\label{rem:thqg-V-gravitational-completion}
...
\begin{equation}\label{eq:thqg-V-completion}
\widehat{\Ydg}_\cA
\;:=\;
\varprojlim_{N}\;
...
(Theorem~\ref{thm:mc2-bar-intrinsic}).  The content is:
\begin{enumerate}[label=\textup{(\arabic*)}]
