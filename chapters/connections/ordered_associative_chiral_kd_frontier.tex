...
power (AP19), yielding $m_2(J,J;\lambda) = \lambda$ from the
...
arity~$n$.  For the quantum algebra:
\begin{itemize}[nosep]
...
\medskip
\noindent\textbf{Part~II: The OPE structure and pole
orders.}
...
\end{tabular}
\end{center}
The collision depth column applies AP19 (the $d\log$ kernel
...
\medskip
\noindent\textbf{Part~III: Six-level depth stratification.}
...
\medskip
\noindent\textbf{Part~IV: The $R$-matrix and
intra-weight mixing.}
...
\medskip
\noindent\textbf{Part~II: The OPE structure.}
...
$\{T_\lambda T\} = \frac{c}{2}\lambda^3 + 2T\lambda
+ \partial T$,
...
\medskip
\noindent\textbf{Part~III: Depth stratification ---
...
\medskip
\noindent\textbf{Part~VI: The depth spectrum and
comparison.}

At arity~$2$, the depth spectrum is determined by the
...
\text{no gap.}
\end{equation}
There is \emph{no depth gap at arity~$2$}.  This
...
\emph{At higher arities:} the Virasoro subsector
...
\emph{The depth spectrum at arity~$2$.}  The
...
arity~$2$}: the $\lambda^2$ coefficient fills in depth $2$
...
\medskip
\noindent\textbf{Part~IV: Non-primitive coproduct ---
...
\medskip
\noindent\textbf{Part~V: The self-dual point.}
...
a nonzero constant $\kappa_0^{(2,2)}$: by AP24, this is
...
Moreover, the rectangular orbit $(2,2)$ --- absent from
