...
\label{def:thqg-I-sewing-hilbert-space}
...
\begin{equation}\label{eq:thqg-I-sewing-hilbert}
...
\label{rem:thqg-I-norm-independence}
...
\label{prop:thqg-I-inclusion-maps}
...
\begin{equation}\label{eq:thqg-I-inclusion}
...
\begin{equation}\label{eq:thqg-I-hs-sewing-condition}
...
\label{def:thqg-I-hs-trace-norms}
...
\begin{equation}\label{eq:thqg-I-hs-composition}
...
\begin{equation}\label{eq:thqg-I-mq-hs-bound}
...
\label{rem:thqg-I-sewing-topology}
...
\label{thm:thqg-I-hs-sewing-criterion}
...
\begin{equation}\label{eq:thqg-I-hs-criterion-bound}
...
\label{rem:thqg-I-hs-optimality}
...
\begin{equation}\label{eq:thqg-I-hs-heisenberg-norm}
...
\begin{equation}\label{eq:thqg-I-hs-heisenberg-factorization}
...
\item The HS norm satisfies
  \begin{equation}\label{eq:thqg-I-hs-affine-norm}
...
\item The HS sum converges:
  \begin{equation}\label{eq:thqg-I-hs-virasoro-norm}
...
\label{comp:thqg-I-hs-betagamma}
...
\item The HS norm:
  \begin{equation}\label{eq:thqg-I-hs-betagamma-norm}
...
\item Convergence:
  \begin{equation}\label{eq:thqg-I-hs-wn-norm}
...
\item The HS norm factors as
  \begin{equation}\label{eq:thqg-I-hs-lattice-norm}
...
\item The HS norm:
  \begin{equation}\label{eq:thqg-I-hs-fermion-norm}
...
\label{prop:thqg-I-trace-class-amplitudes}
...
\begin{equation}\label{eq:thqg-I-sewing-amplitude}
...
\begin{equation}\label{eq:thqg-I-uniform-trace}
...
\begin{equation}\label{eq:thqg-I-Z-g}
...
\label{def:thqg-I-shadow-free-energy}
\index{shadow free energy!definition|textbf}
For a modular Koszul chiral algebra $\cA$ with universal Maurer--Cartan class $\Theta_\cA \in \mathrm{MC}(\gAmod)$ (Theorem~\ref{thm:mc2-bar-intrinsic}), the \emph{genus-$g$ shadow free energy} is the degree-zero shadow representation:
\begin{equation}\label{eq:thqg-I-Fg-def}
...
\label{rem:thqg-I-shadow-algebra-relation}
...
\label{rem:thqg-I-vacuum-energy}
...
\begin{equation}\label{eq:thqg-I-Fg-formula}
...
\begin{equation}\label{eq:thqg-I-cosecant-bernoulli}
...
\label{rem:thqg-I-ahat-connection}
...
&\;\sim\; \frac{2|\kappa(\cA)|}{(2\pi)^{2g}}. \label{eq:thqg-I-Fg-asymptotics}
\end{align}
...
\label{rem:thqg-I-factorial-convergent}
...
\begin{align}
F_1(\cA) &= \frac{\kappa}{24}, \label{eq:thqg-I-F1}\\
F_2(\cA) &= \frac{7\kappa}{5760}, \label{eq:thqg-I-F2}\\
F_3(\cA) &= \frac{31\kappa}{967680}, \label{eq:thqg-I-F3}\\
F_4(\cA) &= \frac{127\kappa}{154828800}, \label{eq:thqg-I-F4}\\
F_5(\cA) &= \frac{73\kappa}{3503554560}, \label{eq:thqg-I-F5}\\
F_6(\cA) &= \frac{1414477\kappa}{2678117105664000}, \label{eq:thqg-I-F6}\\
F_7(\cA) &= \frac{8191\kappa}{612141052723200}, \label{eq:thqg-I-F7}\\
F_8(\cA) &= \frac{16931177\kappa}{49950709902213120000}, \label{eq:thqg-I-F8}\\
F_9(\cA) &= \frac{5749691557\kappa}{669659197233029971968000}, \label{eq:thqg-I-F9}\\
F_{10}(\cA) &= \frac{91546277357\kappa}{420928638260761696665600000}. \label{eq:thqg-I-F10}
\end{align}
\end{proposition}
...
At genus $g = 2$: $F_2 = \kappa \cdot \frac{3}{4} \cdot \frac{1/30}{24} = \kappa \cdot \frac{3}{4} \cdot \frac{1}{720} = \frac{3\kappa}{2880}$.  Simplifying: $F_2 = \kappa \cdot \frac{7}{8} \cdot \frac{1/30}{24} = \kappa \cdot \frac{7}{8 \cdot 720} = \frac{7\kappa}{5760}$.
...
\label{tab:thqg-I-Fg-specializations}
...
\label{rem:thqg-I-numerical-magnitudes}
...
\label{prop:thqg-I-partial-sums}
...
S_3 &= S_2 + F_3 = 0.04291\,, \notag \\
S_4 &= S_3 + F_4 = 0.04291\,, \notag \\
S_5 &= S_4 + F_5 = 0.04291\,, \label{eq:thqg-I-partial-sums}
\end{align}
...
\label{def:thqg-I-grav-partition}
...
\begin{equation}\label{eq:thqg-I-Z-grav-def}
...
\begin{equation}\label{eq:thqg-I-Z-grav-scalar}
...
\begin{equation}\label{eq:thqg-I-4d-divergence}
...
\label{rem:thqg-I-contrast-string}
...
\label{prop:thqg-I-koszulness-finiteness}
...
\item At each arity $r$ and genus $g$, the graph sum
  \begin{equation}\label{eq:thqg-I-graph-sum-finite}
...
\begin{equation}\label{eq:thqg-I-graph-bound}
...
\label{prop:thqg-I-genus-g-decomposition}
\index{genus-$g$ amplitude!decomposition}
The genus-$g$ shadow amplitude decomposes as
\begin{equation}\label{eq:thqg-I-genus-g-decomp}
...
\label{thm:thqg-I-heisenberg-partition}
...
\begin{equation}\label{eq:thqg-I-heisenberg-Zg}
...
\begin{equation}\label{eq:thqg-I-heisenberg-Fg}
...
\begin{equation}\label{eq:thqg-I-green-genus-g}
...
\label{rem:thqg-I-belavin-knizhnik}
...
\begin{equation}\label{eq:thqg-I-Kg-trace-norm}
...
\begin{equation}\label{eq:thqg-I-genus2}
...
\label{ex:thqg-I-genus3-heisenberg}
...
\label{rem:thqg-I-rank-d-heisenberg}
...
\begin{equation}\label{eq:thqg-I-rank-d}
...
\item The HS norm at weight level $n$ satisfies the exact formula
  \begin{equation}\label{eq:thqg-I-heisenberg-exact-hs}
...
\label{prop:thqg-I-affine-detail}
...
\item The HS sewing sum satisfies
  \begin{equation}\label{eq:thqg-I-affine-hs-refined}
...
\label{prop:thqg-I-virasoro-detail}
...
\item The refined HS bound:
  \begin{equation}\label{eq:thqg-I-virasoro-refined-hs}
...
\label{rem:thqg-I-singular-fibers}
...
\label{rem:thqg-I-exhaustiveness}
...
\begin{equation}\label{eq:thqg-I-brown-henneaux}
c \;=\; \frac{3\ell}{2G}\,,
\end{equation}
...
\label{rem:thqg-I-semiclassical}
...
\begin{equation}\label{eq:thqg-I-btz-F1}
...
\begin{equation}\label{eq:thqg-I-btz-full}
...
\label{rem:thqg-I-comparison-btz}
...
\begin{equation}\label{eq:thqg-I-btz-Fg}
...
\begin{align}
F_1^{\mathrm{BTZ}} &= \frac{c}{48}\,, \label{eq:thqg-I-btz-F1-val} \\
F_2^{\mathrm{BTZ}} &= \frac{7c}{11520}\,, \label{eq:thqg-I-btz-F2-val} \\
F_3^{\mathrm{BTZ}} &= \frac{31c}{1935360}\,, \label{eq:thqg-I-btz-F3-val} \\
F_4^{\mathrm{BTZ}} &= \frac{127c}{309657600}\,, \label{eq:thqg-I-btz-F4-val} \\
F_5^{\mathrm{BTZ}} &= \frac{73c}{7007109120}\,. \label{eq:thqg-I-btz-F5-val}
\end{align}
...
\begin{equation}\label{eq:thqg-I-quartic-contact}
...
\begin{equation}\label{eq:thqg-I-genus1-hessian}
...
\label{rem:thqg-I-depth-complexity}
...
\label{prop:thqg-I-1c-expansion}
...
\begin{equation}\label{eq:thqg-I-1c-expansion}
...
\begin{equation}\label{eq:thqg-I-G-expansion}
...
\begin{equation}\label{eq:thqg-I-borel-transform}
...
\label{sssec:thqg-stokes-steinberg}
...
\label{constr:thqg-stokes-filtered-steinberg}
...
\label{prop:thqg-stokes-bm-resurgence}
...
\begin{equation}\label{eq:thqg-stokes-bm-decomposition}
...
\label{rem:thqg-stokes-positivity}
...
\label{rem:thqg-I-holographic-dictionary}
...
\label{rem:thqg-I-finiteness-summary}
...
\begin{equation}\label{eq:thqg-I-chain}
...
\label{subsec:thqg-I-hs-mc-recursion}
...
\label{prop:thqg-I-graph-sum-sewing}
...
\begin{equation}\label{eq:thqg-I-graph-sewing}
...
\label{prop:thqg-I-graph-sum-convergence}
...
\begin{equation}\label{eq:thqg-I-graph-sum-arity}
...
\label{rem:thqg-I-two-mechanisms}
...
\begin{equation}\label{eq:thqg-I-agreement}
...
\begin{equation}\label{eq:thqg-I-full-finite-depth}
...
\begin{equation}\label{eq:thqg-I-leading-term}
...
\label{tab:thqg-I-modular-characteristics}
...
\label{rem:thqg-I-lattice-ortho}
...
\label{prop:thqg-I-hs-filtration}
...
\begin{equation}\label{eq:thqg-I-strong-filtration}
...
\label{rem:thqg-I-mc4-connection}
...
\label{prop:thqg-I-effective-bound}
...
\begin{equation}\label{eq:thqg-I-effective-bound}
...
\begin{equation}\label{eq:thqg-I-2d-convergence}
...
\label{rem:thqg-I-no-uv-detailed}
...
\begin{equation}\label{eq:thqg-I-heisenberg-selberg}
...
\begin{equation}\label{eq:thqg-I-selberg-expansion}
...
\label{rem:thqg-I-spectral-geometric}
...
\begin{equation}\label{eq:thqg-I-polyakov}
...
\label{prop:thqg-I-pole-structure}
...
\label{rem:thqg-I-partial-fraction}
...
\begin{equation}\label{eq:thqg-I-partial-fraction}
...
\begin{equation}\label{eq:thqg-I-entropy-divergence}
...
\label{rem:thqg-I-bekenstein-hawking}
...
\label{rem:thqg-I-virasoro-self-dual}
...
\label{prop:thqg-I-tensor-product}
...
\item The tensor product $\cA = \cA_1 \otimes \cdots \otimes \cA_m$ satisfies HS-sewing, with
  \begin{equation}\label{eq:thqg-I-tensor-hs}
...
\item The gravitational partition function is multiplicative at the scalar level:
  \begin{equation}\label{eq:thqg-I-tensor-partition}
...
\label{rem:thqg-I-complete-finiteness}
...
\label{subsec:thqg-I-fp-coefficients}
...
\label{prop:thqg-I-asymptotic-precision}
...
\begin{equation}\label{eq:thqg-I-relative-error}
...
\begin{equation}\label{eq:thqg-I-fp-monotone}
...
\begin{equation}\label{eq:thqg-I-q-form}
...
\label{rem:thqg-I-convergence-speed}
