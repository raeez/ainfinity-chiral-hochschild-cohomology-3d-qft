...
identity (Corollary~\ref{conj:cubic-rwi}) is equivalent to the
...
principle; \ClaimStatusConditional]
...
\begin{theorem}[General half-space BV quantization; \ClaimStatusConditional]
