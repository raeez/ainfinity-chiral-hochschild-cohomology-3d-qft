...
This volume establishes foundations for $A_\infty$ chiral algebras in 3d holomorphic-topological quantum field theories, connecting to vertex algebra theory, deformation quantization, and quantum groups.
