...
\S\ref{sec:rft-heisenberg-example}, where the relative Feynman
...
\item \textbf{Closed-point collisions:} a subset $S \subset \{1,\ldots,k\}$ of closed insertions collides in $X \setminus D$, producing the face $D_S \cong \FM_{k-|S|+1}(X) \times \FM_{|S|}(\C)$.  These contribute the bar differential $d_{\mathrm{res}}$ (OPE residues along collision divisors).
