...
\item The generating function over genera, with AP22-compliant grading
  $\hbar^{2g}$, is
...
(in the AP22-compliant convention).
\end{proof}
...
distinct invariants (AP20): $c$ governs the Virasoro anomaly of the
