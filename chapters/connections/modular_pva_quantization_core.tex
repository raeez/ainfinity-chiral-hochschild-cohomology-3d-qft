...
\begin{abstract}
This chapter reorganizes the entire discussion of the present thread into a single fortified
...
\item \emph{formal algebraic results} proved internally in this chapter once a modular bar datum is given;
...
the \emph{open colour} --- the associative
factor $\Conf_k^{<}(\R)$ --- by rotating the $E_1$ ordering
