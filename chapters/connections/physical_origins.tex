...
% label removed: chap:physical-origins
% label removed: rem:programme-origins
...
% label removed: sec:4d2d

\subsection{The 4d/2d correspondence (BLLPRR)}

\begin{construction}[4d/2d correspondence (BLLPRR)]% label removed: constr:4d2d
...
\begin{theorem}[4d/2d is \texorpdfstring{$\Einf$}{E-infinity}-chiral; \ClaimStatusProvedElsewhere{} \cite{beem-et-al}]% label removed: thm:4d2d-einf
...
\begin{example}[Class \texorpdfstring{$\mathcal{S}$}{S}]% label removed: ex:class-s
...
\begin{conjecture}[Non-commutative CS; \ClaimStatusConjectured]% label removed: conj:nc-cs
...
% label removed: constr:nc-torus-e1
...
% label removed: conj:koszul-morita
...
% label removed: sec:gauge-d-branes
\subsection{D-brane vertex algebras}

\begin{construction}[Open string VOA]% label removed: constr:open-string-voa
Open strings on D-branes in type IIB produce boundary chiral algebras depending on the brane configuration.
\end{construction}

\begin{conjecture}[D-brane algebras are \texorpdfstring{$\Eone$}{E1}; \ClaimStatusConjectured]% label removed: conj:dbrane-e1
...
% label removed: sec:agt

\begin{theorem}[AGT correspondence; \ClaimStatusProvedElsewhere{} \cite{AGT09}]% label removed: thm:agt
...
\begin{corollary}[Virasoro from gauge theory; \ClaimStatusProvedElsewhere{} \cite{AGT09}]% label removed: cor:virasoro-gauge
The Virasoro algebra ($\Einf$-chiral) arises from the AGT computation; $c$ is determined by $\Omega$-background parameters.
\end{corollary}


\begin{conjecture}[\texorpdfstring{$q$}{q}-AGT; \ClaimStatusConjectured]% label removed: conj:q-agt
