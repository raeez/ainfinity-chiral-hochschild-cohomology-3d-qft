...
Volume~I Proposition~\texttt{prop:partition-dependent-complementarity}
proves $c_{\mathrm{sum}}(3,1) = 2$, using the correct central
...
$c+c'=2$, the self-dual point is $c=1$ (approached
...
$\kappa_0^{(2,2)}$, conjectured nonzero by~AP24---the
...
\item \emph{Same-orbit, non-principal} ($(2,2)$):
  ...
  $\kappa+\kappa^!=\kappa_0^{(2,2)}\neq 0$ (\ClaimStatusConjectured; anticipated by~AP24).
