...
the shadow Postnikov obstruction tower of Vol~I.
...
argument propagates to all arities: the $M2$ shadow obstruction tower is
...
\item The shadow obstruction tower terminates at arity~$2$
(class G: Gaussian).
...
as the shadow Postnikov obstruction tower in Vol~I).
\end{proof}
...
wedge product) and the shadow obstruction tower terminates at arity~$2$
