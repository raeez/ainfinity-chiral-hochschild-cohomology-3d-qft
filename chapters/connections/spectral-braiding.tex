...
(Vol~I, Theorem~C; for $\mathcal{W}$-algebras, $\kappa + \kappa^! = K(\fg)$).
...
\ClaimStatusConjectured]
% label removed: thm:bar-kontsevich
...
DK-$0$ to the full DK ladder (MC3, proved for all simple types)) would upgrade
Conjecture~\ref{thm:bar-kontsevich} from the Kontsevich integral
