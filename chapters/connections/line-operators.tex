...
\end{itemize}
The bar construction $\overline{B}_{\mathrm{ch}}$ converts the $A_\infty$ chiral algebra structure (with operations $m_k$ for $k \ge 2$) into a coalgebra, and $\mathcal{A}^!$ is the cobar (dual algebra) of this coalgebra. The Quillen equivalence (Theorem~\ref{thm:homotopy-Koszul}) ensures this conversion preserves the homotopy type of the module category.
