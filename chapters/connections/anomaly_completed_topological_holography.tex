...
\;=\;
\frac{1}{2}\bigl[
c(\mathcal W_\lambda^k)-c(\mathcal W_{\lambda^t}^{k^\vee})
\bigr]
\;=\;
c(\mathcal W_\lambda^k)-\tfrac{1}{2}\,c_{\mathrm{sum}},
\]
which vanishes at the self-dual level $k_{\mathrm{sd}}$
where $c(\mathcal W_\lambda^{k_{\mathrm{sd}}})
=\tfrac{1}{2}c_{\mathrm{sum}}$.  For generic $k$,
...
\kappa(\mathcal B^k)
\;=\;
\tfrac{1}{2}\bigl[c(\mathcal B^k)-c(\mathcal B^{-k-6})\bigr]
\;=\;
c(\mathcal B^k)-38.
\]
With $c(\mathcal B^k)=3(2k{+}1)/(k{+}3)-1$
${}=3(2k{+}1)/(k{+}3)-1$:
\begin{itemize}
\item $\kappa=0$ iff $c=38$, i.e.\ at the self-dual level
  $k_{\mathrm{sd}}$ solving $3(2k{+}1)/(k{+}3)=39$.
\item For generic $k$: $\kappa\neq 0$ and the genus-$1$
