...
\item The arity-$3$ Ward identity gives the
...
\item The arity-$4$ Ward identity produces the
...
\item The infinite tower of higher soft theorems for
...
\begin{equation}% label removed: eq:thqg-VI-cs-from-cubic
S^{(1)}_{\mathrm{CS}}
\;=\;
...
$\mathbf{C}$ &
  $4$ &
  $\mathrm{BMS}_4 \rtimes \mathfrak{q}_4$ &
  Quartic gravity \\
$\mathbf{M}$ &
  $\infty$ &
  $\mathcal{W}_{1+\infty}$ &
...
$\mathrm{BMS}_4$ by the quartic sector~$\mathfrak{q}_4$, a
one-dimensional abelian extension from the quartic contact invariant.
