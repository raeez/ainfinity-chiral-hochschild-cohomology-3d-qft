...
%   - def:shadow-postnikov-tower (shadow Postnikov obstruction tower)
...
and the shadow Postnikov obstruction tower is
...
leading term of the shadow Postnikov obstruction tower and is proved to exist
...
$\Theta_\cA$ and the compatibility of the shadow Postnikov obstruction tower
...
\item The quintic shadow $\Sh_5(\mathrm{Vir}_c) \neq 0$, and
  the shadow Postnikov obstruction tower does not terminate at arity~$4$.
...
\item $o_{r+1}(\cA) \neq 0$ for all $r \geq 2$.
\item The shadow Postnikov obstruction tower is genuinely infinite:
  $r_{\max}(\cA) = \infty$.
...
non-formal and the celestial/gravitational reading is read as having
...
\bottomrule
\end{tabular}
\caption{Dictionary between the shadow Postnikov obstruction tower and the
...
shadow Postnikov obstruction tower provides the hierarchy, and the shadow
