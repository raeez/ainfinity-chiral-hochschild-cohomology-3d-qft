...
$\kappa_{\mathrm{eff}}(\mathcal W_3{}_{50})=0$.
\end{remark}
...
\end{enumerate}
The boundary fixes the formal-local bulk model at all genera, and in
physical realizations the bridge theorems identify that model with the
bulk package: the holographic dictionary is presented by the transgression algebra, as the
