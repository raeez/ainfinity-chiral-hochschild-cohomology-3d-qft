...
\item \(\Theta_g\) is central because \(\kappa(\cA)\) is scalar
  (Volume~I, Theorem~D, the modular characteristic): the Hochschild bridge
...
all elements of \(A_\partial^!\).  Primitivity: the curvature is a scalar
...
as the Swiss-cheese coalgebra is presented by the bar complex.
\end{remark}
