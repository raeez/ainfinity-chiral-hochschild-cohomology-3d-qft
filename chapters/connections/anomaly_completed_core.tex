...
bulk holomorphic-topological operator algebras are classical or shifted-Poisson/chiral objects, boundary algebras are their quantum and often noncommutative chiral shadows, line operators are controlled by Koszul-dual algebras, and higher operations encode deformation and anomaly data.  (For the spectral factorization structure, the naive strictification obstruction---the spectral Drinfeld class---vanishes for all simple Lie algebras by root multiplicity one; see Theorem~\ref{thm:complete-strictification}.  The anomaly data is a separate, genus-dependent phenomenon.)
...
theory (Theorem~\ref{thm:physics-bridge}), because:
