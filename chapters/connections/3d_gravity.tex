...
\]
The shadow tower of Virasoro at the symmetric point is
...
shadow tower to the semicircular law: the Marchenko--Pastur
...
phenomenon in the $\Ainf$ setting: the shadow tower
...
duality architecture of Part~VII provides a finer invariant:
...
\subsection{BTZ quantum corrections from the shadow tower}
\label{subsec:gravity-btz-quantum}
\index{BTZ black hole!quantum corrections|textbf}

The leading BTZ entropy (Theorem~\ref{thm:gravity-btz-entropy})
is the genus-$0$ projection of the gravitational MC element.
The shadow tower provides a systematic genus expansion of
quantum corrections.

\begin{proposition}[BTZ genus expansion; \ClaimStatusHeuristic]
\label{thm:gravity-btz-genus-expansion}
...
the shadow tower at the scalar level
...
thermal AdS saddles.  The shadow tower encodes this
...
\begin{proposition}[de~Sitter shadow tower; \ClaimStatusHeuristic]
...
\item The shadow tower continues with
