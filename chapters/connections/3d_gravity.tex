...
\]
The celestial stress tensor generates the celestial OPE algebra
with the same Virasoro OPE at $c = 3\ell/(2G)$.  In the
celestial/gravitational reading, this binary celestial soft algebra is
read as the soft-graviton and asymptotic-symmetry package at null
infinity.
...
complementarity invariant (AP24).
...
The collision residue of the bar differential (AP19: $d\log$
