...
computation: $\int_{\overline{\cM}_g} \lambda_g = B_{2g}/(2g \cdot
(2g-2)!)$ (Faber's formula), and the generating function of these
...
$u_{\mathrm{eff}}(\mathrm{Vir}_c) = \kappa_{\mathrm{eff}} \cdot \omega_g = \tfrac{c-26}{2} \cdot \omega_g$;
at $c = 26$ the effective class $u_{\mathrm{eff}}$ vanishes and modular invariance is restored.  The genus--Clifford
