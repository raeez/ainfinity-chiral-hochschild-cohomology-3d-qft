...
\begin{remark}
\label{def:cbt-wedge-functorial}
...
\begin{remark}
\label{def:cbt-bridge-to-w-type}
...
\label{sec:cbt-ordered-all-arity}
...
\label{cor:cbt-all-arities-nonzero}
\ClaimStatusProvedHere
For every $n\ge3$,
\[
...
\begin{remark}
\label{def:cbt-slope-comparison}
...
\begin{remark}
\label{def:cbt-universal-first-correction}
