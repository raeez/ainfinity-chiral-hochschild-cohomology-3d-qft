...
\emph{not} chirally Koszul---the fourth-order pole causes
purity failure and non-concentrated bar cohomology---though
it possesses a well-defined Koszul dual
($\mathrm{Vir}_c^! = \mathrm{Vir}_{26-c}$) carrying
higher $A_\infty$ operations.  Shadow depth classifies the
