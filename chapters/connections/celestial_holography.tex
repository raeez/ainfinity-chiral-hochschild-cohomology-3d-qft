...
\begin{conjecture}[Modular twisted/celestial holography]
...
operations.  The one-vertex sectors already exhibit a surprisingly rigid arithmetic structure.
...
arise.  This is already a striking contrast with the generic loop sectors of the KK theory,
...
\begin{conjecture}[Low mixed cubic reflection law --- provisional]
...
\begin{conjecture}[Explicit charged quartic jet --- provisional]
...
\begin{conjecture}[First mixed bubble coefficient --- provisional]
...
That is the strengthened, fortified, first-principles form of the story.  The disk-level boundary
