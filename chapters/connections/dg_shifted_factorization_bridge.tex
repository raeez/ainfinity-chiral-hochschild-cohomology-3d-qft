...
$\SCchtop$-algebra structure canonically produces a
\emph{spectral quasi-factorization quantum group}, and the
passage from quasi to strict is governed by a concrete
...
(Vol~I, Definition~\ref{def:sewing-kernel}).
...
category.  The Gram matrix $\mathscr{M}_\cA(\alpha) \succ 0$
(Vol~I, Theorem~\ref{thm:gram-positivity}) is the
