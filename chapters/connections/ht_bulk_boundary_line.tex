...
%% ----------------------------------------------------------------
%%  Kodaira--Spencer holography and modular defect observables
%% ----------------------------------------------------------------
...
Define
$A^!_{M2} := \Omega\,\overline{B}(A_{M2,\infty})$,
...
In the shadow hierarchy, $\mathcal{W}_3$ is the first place where
the gravitational cubic sector and the quartic contact sector
coexist in a genuinely inseparable way.
\end{example}
