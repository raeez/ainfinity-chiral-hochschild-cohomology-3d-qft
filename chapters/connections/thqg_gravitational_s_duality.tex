...
\item $\kappa(\mathrm{Vir}_0) = 0$: the bar complex is uncurved ($d_B^2 = 0$),
  but this does not by itself identify the full higher-arity shadow
  tower.
...
self-dual, but this does not identify the full higher-arity shadow
...
here: the all-genus scalar factorization is only proved on the
scalar lane.
\end{computation}
