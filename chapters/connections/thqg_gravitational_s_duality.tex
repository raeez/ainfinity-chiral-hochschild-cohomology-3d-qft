...
the bar coalgebra of~$\cA$ to the bar coalgebra of the Koszul
dual~$\cA^!$, which on the Koszul locus (e.g.\ Virasoro) is formal.  This section derives
...
\item $\kappa(\mathrm{Vir}_0) = 0$: the bar complex is uncurved
  ...
  (class~M, $r_{\max} = \infty$; the higher-arity
  shadow components are nontrivial by AP31).
