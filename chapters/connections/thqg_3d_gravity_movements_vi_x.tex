...
% label removed: subsec:gravity-s-duality
...
% label removed: thm:gravity-verdier-intertwining
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-complementarity-constant
...
\begin{equation}% label removed: eq:gravity-complementarity-K
K
\;=\;
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-self-dual-13
...
% label removed: rem:gravity-13-not-critical
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-c26-anomaly-cancellation
...
% RECTIFICATION-FLAG (AP20): F_g(Vir_26) = kappa(Vir_26)*lambda_g = 13*lambda_g ≠ 0.
% What vanishes is F_g^eff of the combined system Vir_26 ⊗ bc_2.
% Similarly, F_g(Vir_0) = 0 (kappa=0), not -13*lambda_g.
% The -13 belongs to F_g^eff(Vir_0 ⊗ bc_2).
\item $F_g^{\mathrm{eff}}(\mathrm{Vir}_{26} \otimes bc_2) = 0$ for all $g \ge 1$:
  the combined matter--ghost partition function is identically~$1$,
  since $\kappa_{\mathrm{eff}} = \kappa(\mathrm{Vir}_{26}) + \kappa(bc_2)
  = 13 - 13 = 0$.
\item The effective genus tower of the dual side is
...
% label removed: thm:gravity-shadow-duality
...
\begin{equation}% label removed: eq:shadow-duality
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-connection-duality
...
\begin{equation}% label removed: eq:connection-duality
\mathbb{D}\!\left(
  \nabla^{\mathrm{hol}}_{0,n}(\mathrm{Vir}_c)
\right)
\;=\;
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-genus-tower-duality
The genus-$g$ free energies satisfy
\begin{equation}% label removed: eq:genus-tower-duality
...
% label removed: def:gravity-s-duality-map
...
% label removed: rem:gravity-s-duality-order-two
...
% label removed: subsec:gravity-complexity
...
\ClaimStatusProvedHere]
% label removed: thm:gravity-quintic-obstruction
...
% label removed: eq:gravity-o5-leading
\end{align}
...
% label removed: def:gravity-shadow-depth-class
...
% label removed: def:gravity-complexity-class
\index{complexity class!gravitational G/L/C/M}
...
\ClaimStatusProvedHere]
% label removed: constr:gravity-collision-ss
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-ss-non-collapse
...
% label removed: prop:gravity-jet-dimensions
...
% label removed: subsec:gravity-perturbative-finiteness
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-hs-sewing
...
\ClaimStatusProvedHere]
% label removed: thm:gravity-genus-convergence
\index{genus tower!convergence!gravitational}
The all-genera free energy
\begin{equation}% label removed: eq:gravity-all-genera
...
% label removed: rem:gravity-no-uv
...
% label removed: prop:gravity-bernoulli-control
...
% label removed: subsec:gravity-soft-theorems
...
This is determined by the Laplace kernel
$r^L(z) = (c/2)/z^4 + 2T/z^2 + \partial T/z$
(\S\ref{subsec:gravity-r-matrix}); equivalently, the collision
...
\ClaimStatusProvedHere]
% label removed: thm:gravity-cubic-gauge-trivial
...
gives
\begin{equation}% label removed: eq:quartic-soft-ward
\left\langle
  S_4(z_0) \cdot
...
% label removed: prop:gravity-celestial-soft
...
structure}
% label removed: subsec:gravity-critical-string-fredholm
...
% label removed: def:gravity-transgression
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-u-closed-central
...
% label removed: def:gravity-genus-g-completion
...
\ClaimStatusProvedHere]
% label removed: thm:gravity-morita-triviality
\index{Morita triviality!gravitational}
If $u$ is invertible \textup{(}i.e., after localization at
$u$\textup{)}, then
\begin{equation}% label removed: eq:gravity-morita
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-c26-degeneration
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-c13-anomaly
...
% label removed: thm:gravity-heisenberg-fredholm
...
\begin{equation}% label removed: eq:heisenberg-fredholm
Z_g(\cH_k)
\;=\;
...
determinants; \ClaimStatusProvedHere]
% label removed: thm:gravity-virasoro-not-fredholm
...
% label removed: def:gravity-fredholm-defect
...
\ClaimStatusProvedHere]
% label removed: prop:gravity-fredholm-defect
...
% label removed: rem:gravity-cumulant-interpretation
