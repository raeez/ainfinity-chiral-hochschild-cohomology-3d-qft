...
read as the corresponding soft hierarchy.  Each $S_r$ encodes a Ward identity constraining the
...
$S_3$ encodes no new independent soft statement, since in that reading
it is gauge-trivial (a consequence of cubic gauge triviality);
$S_4$ encodes the first quartic-contact correction, controlled by the
quartic contact invariant $\mathfrak{Q}^{\mathrm{contact}}
= 10/(c(5c+22))$;
$S_5$ encodes the first genuinely new higher-arity Ward identity in that
reading.
...
\index{celestial holography!celestial soft algebra}
...
the Virasoro sector of the resulting soft algebra at null infinity
...
soft algebra is read as the extended BMS package, and the celestial
...
read as extending that package through the projections of
