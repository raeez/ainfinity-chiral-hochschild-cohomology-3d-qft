...
depth of the shadow Postnikov obstruction tower and does not refer to the
...
Movement~IX asks what the individual shadows \emph{do} --- not
genus by genus, but arity by arity, as celestial soft factors.
