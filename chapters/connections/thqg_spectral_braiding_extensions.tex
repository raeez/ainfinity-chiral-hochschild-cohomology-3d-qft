...
\textup{(}Volume~I, Remark~\textup{\ref{rem:three-r-matrices}}\textup{)}:
\begin{equation}
r^{\mathrm{coll}}_{\mathrm{Vir}_c}(z)
\;=\;
...
the Virasoro in the $M$ (mixed) class: the shadow tower does not
...
$\widehat{\fg}_k$ & $\Omega/z + k\kappa/z^2$ [Laplace] & structure constants $f^{ab}_c$ & $L$ \\
