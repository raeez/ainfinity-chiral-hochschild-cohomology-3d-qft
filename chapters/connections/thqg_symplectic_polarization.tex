...
The sign in~\eqref{eq:thqg-III-theta-intertwine} arises when
one passes to genus-$g$ projections through the bilinear
pairing.  By
Proposition~\ref{prop:lagrangian-eigenspaces}(ii), $\sigma$
...
$\kappa + \kappa^! = K(\fg)$ for general $\mathcal{W}$-algebras:
...
The shadow obstruction tower terminates at arity $2$ because
