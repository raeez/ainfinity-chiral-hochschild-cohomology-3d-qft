...
% label removed: prop:thqg-III-ambient-properties
...
% label removed: constr:thqg-III-verdier-involution
...
\ClaimStatusProvedHere]
% label removed: prop:thqg-III-involutivity
...
\ClaimStatusProvedHere]
% label removed: prop:thqg-III-mc-compatibility
...
$\kappa(\cA) + \kappa(\cA^!) = 0$ for Kac--Moody and free-field algebras: the modular characteristic
$\kappa(\cA)$ is duality-constrained under Feigin--Frenkel duality
(Theorem~\ref{thm:kappa-anti-symmetry}; for $\mathcal{W}$-algebras, $\kappa + \kappa^! = K(\fg)$).
...
% label removed: def:thqg-III-holographic-pairing
...
\ClaimStatusProvedHere]
% label removed: lem:thqg-III-nondegeneracy
...
% label removed: subsec:thqg-III-eigenspace-decomposition
...
\ClaimStatusProvedHere]
% label removed: thm:thqg-III-eigenspace-decomposition
...
\ClaimStatusProvedHere]
% label removed: prop:thqg-III-genus-1
...
% label removed: subsec:thqg-III-shifted-symplectic
...
% label removed: def:thqg-III-shifted-symplectic
...
% label removed: def:thqg-III-ptvv-lagrangian
...
% label removed: ex:thqg-III-linear-shifted
...
\cite{Pridham17}}]
% label removed: prop:thqg-III-kontsevich-pridham
...
\ClaimStatusProvedHere]
% label removed: thm:thqg-III-bv-lagrangian
...
% label removed: thm:thqg-III-lagrangian-polarization
...
% label removed: subsec:thqg-III-complementarity-potential
...
\begin{equation}% label removed: eq:thqg-III-all-arity-master
...
% label removed: subsec:thqg-III-holographic-entanglement
...
% label removed: subsec:thqg-III-standard-landscape
