...
Precisely:
\begin{itemize}
\item The bulk $A_{\mathrm{bulk}} = \cO(\cM)|_{\cL}$
  is the restriction of the ambient structure sheaf to the
  Lagrangian---it lives on $\cL$, \emph{not} on
  $\mathfrak{S}_b$.
\item The boundary $B_\partial = \cO(\cL)$ is functions
  on the Lagrangian itself---again on $\cL$, not on
  $\mathfrak{S}_b$.
