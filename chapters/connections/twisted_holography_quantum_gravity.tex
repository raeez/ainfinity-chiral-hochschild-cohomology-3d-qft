...
\hbar^g\,\Theta_\cA^{(g,s)}$ are the shadow Postnikov obstruction tower.
...
\subsection{The shadow Postnikov obstruction tower}
...
The first three layers of the shadow Postnikov obstruction tower are:
\begin{enumerate}[label=\textup{(\roman*)}]
...
\item The shadow Postnikov obstruction tower is the primary nonlinear object:
