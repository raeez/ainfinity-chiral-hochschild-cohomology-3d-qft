...
statement for the platonic package and universal MC class
...
On the affine lineage, this residue recovers the proved dg-shifted
Yangian realization of Theorem~\ref{thm:Koszul_dual_Yangian};
more generally it is the classical input for the conjectural
perturbative gravitational-Yangian package.  Independently, the
line-operator category is the open-colour module category
$\mathcal{C} \simeq \cA^!\text{-}\mathsf{mod}$
