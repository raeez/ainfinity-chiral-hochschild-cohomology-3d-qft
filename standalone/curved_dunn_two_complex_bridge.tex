...
transverse $E_1$ factor. This transverse factor is the Hom-side
Koszul-dual factor in the comparison complex, not a second
independent $E_1$-structure on the within-surface algebra. The bridge
is the required comparison.
\end{remark}
...
the open-colour transverse $E_1$ bar on the Hom/Koszul-dual side,
with twisting cochain built recursively from $R$-matrix monodromy at
genus-raising clutching. The tensor product is therefore a comparison
complex; it is not a product decomposition of the original
within-surface $E_1$ algebra.
