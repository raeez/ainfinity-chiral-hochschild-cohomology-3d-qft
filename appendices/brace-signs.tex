...
|s^{-1} f| = |f| - 1
\]
since desuspension lowers degree by one. Koszul sign rule: transposing graded elements $f$ and $g$ incurs $(-1)^{|f|\cdot|g|}$ on the desuspended complex $s^{-1} C^\bullet$.
